                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<?php echo site_url('kategori'); ?>">Lihat Data Kategori</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <?php echo form_open_multipart('kategori/ubahproses');?>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="hidden" name="idKategori" value="<?php echo $kategori->idKategori; ?>">
                                        <input type="text" class="form-control" name="namaKategori" value="<?php echo $kategori->namaKategori; ?>" required>
